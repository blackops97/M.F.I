...
local msgs = 
{
    already_locked = "تم بالفعل تفعيل منع التكلم عن الحب", -- the message that sent when you try to lock the fuck and it's already locked
    Locked = "تم 🌝✋🏿 تفعيل مضاد التكلم ع الحب 💋😍", -- the message that send when you lock the fuck

    already_unlocked = "تم بالفعل ايقاف تفعيل منع التكلم عن الحب", -- the message that sent when you try to unlock the fuck and it's already unlocked
    UnLocked = "تم الغاء تفعيل منع التكلم عن الحب 😒🙌🏿", -- the message that send when you unlock the fuck
